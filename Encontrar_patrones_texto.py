def run():
  ...
  for palabra in palabras_unicas:
    codificacion_patron.append(palabra + str(palabras.count(palabra)))
  
  print("".join(codificacion_patron))
