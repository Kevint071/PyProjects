...
from Logica_interfaces import validar_enlace, configurar_botones
...
def crear_contenedor_botones():
    ...
    boton_mp3 = ttk.Button(frame_botones, text="Descargar MP3", command=lambda: (ventana_confirmacion(root, validar_enlace(entry_playlist, label_info), formato_mp3)))
    boton_mp3.pack(side=tk.LEFT, padx=10)

    boton_mp4 = ttk.Button(frame_botones, text="Descargar MP4", command=lambda: (ventana_confirmacion(root, validar_enlace(entry_playlist, label_info), formato_mp4)))
